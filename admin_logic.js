...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function buildAttendantCache(attendances) {
        ...
        attendances.forEach(att => {
            ...
            const id = att.attendantId;
            const nome = att.attendantName; // <<< VERIFIQUE SE ESTE É O CAMPO CORRETO
    ...
    function applyFilters(data, filterPrefix) {
        ...
        return data.filter(item => {
            ...
            if (attendantId !== 'all' && item.attendantId !== attendantId) return false;
    ...
    // Modal listeners
    document.querySelector('.close').addEventListener('click', closeDetailsModal);
